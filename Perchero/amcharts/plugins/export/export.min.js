 ...
 */
var d = new Date();
var strDate = "_" + d.getDate() + "_" + (d.getMonth()+1) + "_" + d.getFullYear();
...
if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
		...
		"fallback.save.image": "Rightclick -> Guardar la imagen como ... para guardar la imagen.",
		...
		"label.saved.from": "Guardado desde: "
	}
}
	...
	AmCharts[ "export" ] = function( chart, config ) {
		...
		var _this = {
			...
			libs: {
				...
				autoLoad: true,
				reload: false,
				resources: [ "http://localhost:5900/amcharts/plugins/export/libs/fabric.js/fabric.min.js", "http://localhost:5900/amcharts/plugins/export/libs/FileSaver.js/FileSaver.min.js", "http://localhost:5900/amcharts/plugins/export/libs/jszip/jszip.min.js", "http://localhost:5900/amcharts/plugins/export/libs/xlsx/xlsx.min.js", {
					"http://localhost:5900/amcharts/plugins/export/libs/pdfmake/pdfmake.min.js": [ "http://localhost:5900/amcharts/plugins/export/libs/pdfmake/vfs_fonts.js" ]
				} ],
				namespaces: {
